...
| [v15_budget_simulator](https://github.com/suguru789987/v15_budget_simulator) | **売上ベース予算⇄利益ベース予算 双方向ブリッジ** + CSVインポート(自動検出) + v18カテゴリマッピング + 地代家賃反復計算×MQ連動 + 計画策定ウィザード5ステップ |
